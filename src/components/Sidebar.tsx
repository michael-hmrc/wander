    ...
    return (
        ...
        >
            ...
            <button
                ...
                type="button"
                className="inline-flex absolute top-4 right-4 p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700"
